...
class PostHashtagService {
    private val hashtagService: HashtagService? = null
    private val postHashtagRepository: PostHashtagRepository? = null
    ...
    fun findPostHashtagByPostId(postId: Long?): List<PostHashtagEntity> {
